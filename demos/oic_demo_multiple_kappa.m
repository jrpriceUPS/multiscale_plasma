...
output2(1).dt=outputhalton23.dt;
output2(1).TList=outputhalton23.TList;
plotparams.legends{1}='Halton sequence, {2,3,5}';
...
output2(2).dt=outputhalton25.dt;
output2(2).TList=outputhalton25.TList;
plotparams.legends{2}='Halton sequence, {2,3,7}';
...
output2(3).dt=outputhalton35.dt;
output2(3).TList=outputhalton35.TList;
plotparams.legends{3}='Halton sequence, {2,5,7}';
...
output2(4).dt=outputhalton57.dt;
output2(4).TList=outputhalton57.TList;
plotparams.legends{4}='Halton sequence, {3,5,7}';
...
output2(11).dt=outputuniform.dt;
output2(11).TList=outputuniform.TList;
plotparams.legends{11}='Uniform';
...
output2(12).dt=outputgrid.dt;
output2(12).TList=outputgrid.TList;
plotparams.legends{12}='Grid';
...
output2(5).dt=outputhalton3511.dt;
output2(5).TList=outputhalton3511.TList;
plotparams.legends{5}='Halton sequence, {3,5,11}';
...
output2(6).dt=outputhalton3711.dt;
output2(6).TList=outputhalton3711.TList;
plotparams.legends{6}='Halton sequence, {3,7,11}';
...
output2(7).dt=outputhalton2511.dt;
output2(7).TList=outputhalton2511.TList;
plotparams.legends{7}='Halton sequence, {2,5,11}';
...
output2(8).dt=outputhalton3513.dt;
output2(8).TList=outputhalton3513.TList;
plotparams.legends{8}='Halton sequence, {3,5,13}';
...
output2(9).dt=outputhalton5713.dt;
output2(9).TList=outputhalton5713.TList;
plotparams.legends{9}='Halton sequence, {5,7,13}';
...
output2(10).dt=outputhalton2513.dt;
output2(10).TList=outputhalton2513.TList;
plotparams.legends{10}='Halton sequence, {2,5,13}';
...
hold on
for i=1:k
plot((0:params.Ndt)*output2(i).dt,output2(i).TList,'Color',plotparams.colors(i,:),'LineWidth',1.5)
dtlist(i) = output2(i).dt;
minTlist(i) = min(output2(i).TList);
maxTlist(i) = max(output2(i).TList);
end
axis([0,params.Ndt*max(dtlist),0.9*min(minTlist),1.1*max(maxTlist)])
...
output3(1).dt=outputhalton23.dt;
output3(1).TList=outputhalton23.TList;
plotparams.legends{1}='Halton sequence, {2,3,5}';
...
output3(2).dt=outputhalton25.dt;
output3(2).TList=outputhalton25.TList;
plotparams.legends{2}='Halton sequence, {2,3,7}';
...
output3(3).dt=outputhalton35.dt;
output3(3).TList=outputhalton35.TList;
plotparams.legends{3}='Halton sequence, {2,5,7}';
...
output3(4).dt=outputhalton57.dt;
output3(4).TList=outputhalton57.TList;
plotparams.legends{4}='Halton sequence, {3,5,7}';
...
output3(11).dt=outputuniform.dt;
output3(11).TList=outputuniform.TList;
plotparams.legends{11}='Uniform';
...
output3(12).dt=outputgrid.dt;
output3(12).TList=outputgrid.TList;
plotparams.legends{12}='Grid';
...
output3(5).dt=outputhalton3511.dt;
output3(5).TList=outputhalton3511.TList;
plotparams.legends{5}='Halton sequence, {3,5,11}';
...
output3(6).dt=outputhalton3711.dt;
output3(6).TList=outputhalton3711.TList;
plotparams.legends{6}='Halton sequence, {3,7,11}';
...
output3(7).dt=outputhalton2511.dt;
output3(7).TList=outputhalton2511.TList;
plotparams.legends{7}='Halton sequence, {2,5,11}';
...
output3(8).dt=outputhalton3513.dt;
output3(8).TList=outputhalton3513.TList;
plotparams.legends{8}='Halton sequence, {3,5,13}';
...
output3(9).dt=outputhalton5713.dt;
output3(9).TList=outputhalton5713.TList;
plotparams.legends{9}='Halton sequence, {5,7,13}';
...
output3(10).dt=outputhalton2513.dt;
output3(10).TList=outputhalton2513.TList;
plotparams.legends{10}='Halton sequence, {2,5,13}';
...
hold on
for i=1:k
plot((0:params.Ndt)*output3(i).dt,output3(i).TList,'Color',plotparams.colors(i,:),'LineWidth',1.5)
dtlist(i) = output3(i).dt;
minTlist(i) = min(output3(i).TList);
maxTlist(i) = max(output3(i).TList);
end
axis([0,params.Ndt*max(dtlist),0.9*min(minTlist),1.1*max(maxTlist)])
