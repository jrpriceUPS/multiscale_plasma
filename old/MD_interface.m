...
% INTERFACE TESTCASE
% 
% MD test case for an interface problem. 
% Initially zero velocity with a constant temperature with a density
% discontinuity.
%
...
params.dt   =   0.0015;                       % default: 0.01
params.Ndt  =   80000;                       % default: 1000
